...
(* 15.8 *)
%public %inline primary: (* expression *)
  | p=primary_no_new_array { p }
  | e=array_creation_expression { e }

%inline primary_no_new_array: (* expression *)
  | l=literal { l }
...
(* 15.9 *)
%public class_instance_creation_expression: (* expression *)
...
(* 15.12 *)
%public method_invocation: (* expression *)
...
%public post_increment_expression: (* expression *)
  | e=postfix_expression INCREMENT { PostfixExpression(e, INCREMENT) }

%public post_decrement_expression: (* expression *)
...
%public pre_increment_expression: (* expression *)
  | INCREMENT e=unary_expression { PrefixExpression(e, INCREMENT) }

%public pre_decrement_expression: (* expression *)
...
(* 15.28 *)
%public constant_expression: (* expression *)
  | e=expression { e }
