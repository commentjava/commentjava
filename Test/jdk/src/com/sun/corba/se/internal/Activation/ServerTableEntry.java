/*
 * @(#)ServerTableEntry.java	1.24 03/01/23
 *
 * Copyright 2003 Sun Microsystems, Inc. All rights reserved.
 * SUN PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.
 */
/*
 * @(#)ServerTableEntry.java 1.1 97/11/30
 *
...
public class ServerTableEntry 
{
    ...
    ServerTableEntry(int serverId, ServerDef serverDef, int initialPort,
	...
	activationCmd = 
	    ...
	    " com.sun.corba.se.internal.Activation.ServerMain " + serverDef.serverArgs
    ...
    synchronized void activate() throws org.omg.CORBA.SystemException
    {
		...
		printDebug("activate", "throwing premature process exit");
            throw (new INTERNAL(MinorCodes.UNABLE_TO_START_PROCESS, 
	...
	if (state == RUNNING)
	    ...
	    throw new INTERNAL( MinorCodes.SERVER_NOT_RUNNING,
				CompletionStatus.COMPLETED_NO ) ;
    }
	...
	ORBPortInfo[] orbAndPortList = null;
		...
		int i;
		    ...
		    //FD	            for (i = 0; i < serverListenerPorts.length; i++) {
	            i = 0;
	            for (; i < serverListenerPorts.length; i++) {
		        if (debug)
